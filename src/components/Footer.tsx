...
export default function Footer() {
  return (
    <footer className="mx-auto max-w-[1400] bg-white pt-16 pb-6 lg:pt-32">
      <Grid className="px-5">
        ...
        <Column span={4} spanMd={2} spanSm={2} className="pt-5 pb-7">
          ...
          <div className="flex flex-col space-y-6">
            ...
            >
              <a
                href="https://instagram.com/amirr_akram"
                target="_blank"
              ...
              <a
                href="https://youtube.com/@karmique"
                target="_blank"
                rel="noopener noreferrer"
                className="nav-link text-base"
              >
      ...
      {/* Large Brand Name */}
      <div className="brand-container mt-16 px-5 items-center justify-center text-center">
      ...
      <div className="flex flex-col items-center justify-between border-t border-gray-100 px-5 pt-8 md:flex-row">
        <p className="text-small text-black">All rights reserved by Mermaide™</p>
        <p className="text-small text-black">Developed by Wyzard.in</p>
      </div>
    </footer>
  );
}
